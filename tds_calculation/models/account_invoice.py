...
#new functions for 
    ...
    def action_move_create(self):
        ...
        for inv in self:
            ...
            # finalizing / returning the evaluated lines for account.move.line
...
class AccountInvoiceLine(models.Model):
    ...
    tds_nod_id = fields.Many2many('account.nod.confg.line', 'tds_id',string='TDS NOD',domain="[('partner_id', '=', partner_id)]")
