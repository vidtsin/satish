...
class AccountTdsMapping(models.Model):
    ...
    tds_group = fields.Many2one('account.tds.group.settings',string="TDS Group")
    date = fields.Datetime(string="Effective Date")
    ...
    non_pan_tds_req = fields.Boolean(string="Check if Non PAD TDS required", default=False)
